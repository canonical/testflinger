try:
    # attempt importing a filter, to check if the feature is present
    from tarfile import data_filter
except ImportError:
    # this version of Python doesn't support filters during tar extraction:
    # extend `TarFile` so that `extractall` supports this functionality
    #
    ...
    class TarFilePatched(TarFile):
        ...
        def extractall(
            ...
            for member in members:
                tarinfo = self._get_extract_tarinfo(
    ...
    # make sure `open` is available when this module is imported
