...
class TestClient:
    ...
    def test_retry_transmit(self, agent, requests_mock):
        ...
        requests_mock.post(rmock.ANY, status_code=200)
        with patch.object(
                testflinger_agent.client.TestflingerClient,
                'transmit_job_outcome') as mock_transmit_job_outcome:
