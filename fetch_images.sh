#!/bin/bash
# Fetch images for each identifier from the live Testflinger server
...
do
  echo "Fetching images for $id..."
  curl -s "https://testflinger.canonical.com/v1/agents/images/$id"
done
