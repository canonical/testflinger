...
- Before calling work complete, run `just check` at the top level and fix any formatting errors; note: when run within a workshop the agent will need to AVOID applying fixes for zizmor due to `gh` not being present in the workshop environment.
